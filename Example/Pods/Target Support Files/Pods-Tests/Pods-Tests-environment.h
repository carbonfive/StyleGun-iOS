...
// StyleGun-iOS
#define COCOAPODS_POD_AVAILABLE_StyleGun_iOS
#define COCOAPODS_VERSION_MAJOR_StyleGun_iOS 0
#define COCOAPODS_VERSION_MINOR_StyleGun_iOS 1
#define COCOAPODS_VERSION_PATCH_StyleGun_iOS 0
